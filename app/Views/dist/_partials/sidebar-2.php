      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo $segment == 'layout_transparent' ? 'active' : ''; ?>">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Layout</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo base_url('dist/layout_default'); ?>">Default Layout</a></li>
                <li class="<?php echo $segment == 'layout_transparent' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url('dist/layout_transparent'); ?>">Transparent Sidebar</a></li>
